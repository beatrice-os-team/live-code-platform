...
emcc main.c ${LOSU_SRC_FILES} ${INCLUDE_DIRS} \
     ...
     -s EXPORTED_FUNCTIONS="['_filesystem_demo', '_filesystem_init', '_demo_fs_read', '_demo_fs_write', '_demo_fs_mkdir', '_demo_fs_readdir', '_demo_fs_unlink', '_demo_fs_rename', '_demo_fs_stat', '_demo_fs_rmdir', '_run', '_malloc', '_free']" \
     -s EXPORTED_RUNTIME_METHODS="['lengthBytesUTF8', 'stringToUTF8']" \
